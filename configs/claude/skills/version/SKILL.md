---
name: version
description: Determines the next version number following Semantic Versioning 2.0.0 by analyzing commit history with Conventional Commits to recommend a MAJOR, MINOR, or PATCH bump.
when_to_use: When the user asks to determine the next version, bump the version, prepare a release, or create a version tag.
